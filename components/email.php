...
<tr style="border-collapse:collapse">
<td align="center" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:40px;padding-bottom:40px"><span class="es-button-border-1678446686849 es-button-border" style="border-style:solid;border-color:#ffffff;background:#1f97ff;border-width:2px;display:inline-block;border-radius:30px;width:auto"><a href="https://alealila.altervista.org/changePasw.php?email=$email&amp;id=$idCode" class="es-button es-button-1678446644108" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#ffffff;font-size:18px;display:inline-block;background:#1f97ff;border-radius:30px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-weight:bold;font-style:normal;line-height:22px;width:auto;text-align:center;padding:15px 20px 15px 20px;border-color:#1f97ff">RESET PASSWORD</a></span></td>
</tr>
<tr style="border-collapse:collapse">
